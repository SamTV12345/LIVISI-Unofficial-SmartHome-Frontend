    ...
    return <aside className={`w-full h-full float-left ${sideBarCollapsed?'hidden': 'grid-cols-1'}`} aria-label="Sidebar">
        <div className="py-4 px-3 bg-gray-800 h-full w-full">
            <ul className="space-y-2">
                ...
                <li>
                    <a href="#"
                       className={`flex items-center p-2 text-base font-normal text-white rounded-lg text-white hover:bg-gray-100 hover:bg-gray-700 ${highlightIfSelected("/devices")}`}>
