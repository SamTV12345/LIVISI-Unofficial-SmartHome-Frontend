    ...
    return <><PageComponent to={"/settings"} title="Netzwerk">
        {
            ...
            <PageBox variant="default">
                <img src="/images/svg_single/connected_wired.svg" alt="Shows the shc to be connected via wire"/>
            </PageBox>
            ...
            <PageBox variant="default">
            <img src="/images/svg_single/connected_wireless.svg" alt="Shows the shc to be connected via wireless"/>
            </PageBox>
