...
import {SVGProps} from "@/components/TurnedOn";

export const TurnedOnGlow: FC<SVGProps> = ({style,onPress})=>{
    return  <Svg id="Layer_1" viewBox="0 0 512 512" style={style} onPress={onPress}>
        <Defs>
        ...
        <G>
            <G>
                <G>
                    <Path fill="url(#glow)" d="M448,117.333H298.667H64c-35.35,0-64,28.66-64,64v149.333c0,35.355,28.645,64,64,64h234.667H448
                ...
                c0-11.779,9.551-21.333,21.333-21.333H448c11.791,0,21.333,9.542,21.333,21.333V330.667z"/>
                    <Path fill="url(#glow)" d="M405.333,202.667C393.551,202.667,384,212.218,384,224v64c0,11.782,9.551,21.333,21.333,21.333
                c11.782,0,21.333-9.551,21.333-21.333v-64C426.667,212.218,417.115,202.667,405.333,202.667z"/>
                    <Path fill="url(#glow)" d="M341.333,202.667C329.551,202.667,320,212.218,320,224v64c0,11.782,9.551,21.333,21.333,21.333
